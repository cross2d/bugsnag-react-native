        ...
        .forEach(ref => {
            ...
            if (shouldVisitBuildSettings) {
                ...
                if (buildSettings['FRAMEWORK_SEARCH_PATHS']) {
                    let paths = '';
                    if( typeof(buildSettings['FRAMEWORK_SEARCH_PATHS'])==='string' ){
                        if(buildSettings['FRAMEWORK_SEARCH_PATHS']!==frameworkSearchPath){
                            paths = buildSettings['FRAMEWORK_SEARCH_PATHS']
                        }
                    }else{
                        paths = _.remove(buildSettings['FRAMEWORK_SEARCH_PATHS'], function (path) {
